  ...
  <div class="container-xxl py-6 pt-5" id="project">
    <div class="container">
        <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
                <h1 class="display-5 mb-0">{{ $t('projects.title') }}</h1>
            </div>
            <div class="col-lg-6 text-lg-end">
                <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                    <li class="mx-3 active" data-filter="*">{{ $t('projects.all') }}</li>
                    <li class="mx-3" data-filter=".backend">Back-End</li>
                    <li class="mx-3" data-filter=".fullstack">Full Stack</li>
                    <li class="mx-3" data-filter=".data">Data/IA</li>
                </ul>
            </div>
        </div>
        <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-4 col-md-6 portfolio-item backend">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-1.jpg" alt="Voyages System">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item data">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-2.jpg" alt="Machine Learning Allocation">
                    <div class="portfolio-btn">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item backend">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-3.jpg" alt="API Mobile REST">
                    <div class="portfolio-btn">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item fullstack">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-4.jpg" alt="Plateforme Formation">
                    <div class="portfolio-btn">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item backend">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-5.jpg" alt="Migration Java vers Python">
                    <div class="portfolio-btn">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item fullstack">
                <div class="portfolio-img rounded overflow-hidden">
                    <img class="img-fluid" src="/img/project-6.jpg" alt="BICI Solutions Clients">
                    <div class="portfolio-btn">
